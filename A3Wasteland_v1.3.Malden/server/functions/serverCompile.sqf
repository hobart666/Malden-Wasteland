...
createCustomGroupCop = [_path, "createUnits\customGroupCop.sqf"] call mf_compile;
createCustomGroupCopSmall = [_path, "createUnits\customGroupCopSmall.sqf"] call mf_compile;
...
createRandomCop = [_path, "createUnits\createRandomCop.sqf"] call mf_compile; 
...
createRandomSoldierB = [_path, "createUnits\createRandomSoldierB.sqf"] call mf_compile;
