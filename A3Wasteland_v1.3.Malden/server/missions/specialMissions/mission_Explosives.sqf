...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Criminal merchants try to sell kids nearly anything! Today's offer:<br/><t color='%1'>Improvised Explosive Devices</t>.<br/>Eliminate these jerks and save the IED - for your own interests!", specialMissionColor];
