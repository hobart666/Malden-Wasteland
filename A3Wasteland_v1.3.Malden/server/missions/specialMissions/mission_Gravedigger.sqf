...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Immoral bastards raided a nearby graveyard. Kill them and send them to their own graves!", specialMissionColor];
...
_successExec =
{
	...
	_successHintMessage = format ["Very Good! You sent the immoral bastards to their own graves!<br/> Save the crates and get outta there!"];
};
