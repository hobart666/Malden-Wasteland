...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy transporting <t color='%1'>%2</t> escorted by a <t color='%1'>%3</t> is en route to an unknown location.<br/>Stop them!", specialMissionColor, _moneyText, _vehicleName];
