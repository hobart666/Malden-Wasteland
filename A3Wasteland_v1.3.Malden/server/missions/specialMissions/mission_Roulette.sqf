...
_setupObjects =
{
    ...
    _missionHintText = format ["<br/>Two aspirants of <t color='%2'>Malden Gendarmerie</t> hold two civilians captive to play justice.<br/> Head there, show them the brutality of real justice:<br/>kill them and <t color='%2'>execute ONLY the guilty civilian</t>!", _vehicleName, specialMissionColor];
};
...
_successExec =
{
    ...
    _successHintMessage = format ["Not bad. More luck than skill, eh?"];
};
