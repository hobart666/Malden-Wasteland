...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Reportedly armed units are trying to <br/><t color='%1'>conquer a small island</t>.<br/>Check this island, find the invaders and kick them back to the sea!", occupationMissionColor];
};
