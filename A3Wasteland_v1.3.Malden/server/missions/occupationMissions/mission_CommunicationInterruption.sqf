...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Paramilitary units occupied a <t color='%1'>radio tower</t> to hack the communications on Malden.<br/>Go there, kill these stupid shitheads and clear the area!", occupationMissionColor];
};
