...
_setupVars =
{
	_missionType = "Mobile Artillary Convoy";
...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["O_APC_Tracked_02_AA_F", "O_MBT_02_arty_F", "I_MBT_03_cannon_F"],
		["O_APC_Tracked_02_AA_F", "B_MBT_01_arty_F", "I_MBT_03_cannon_F"],
		["O_APC_Tracked_02_AA_F", "B_MBT_01_mlrs_F", "O_APC_Tracked_02_AA_F"]
	...
	_missionHintText = format ["A mobile artillary unit think they own the island driving all over the place. Stop them!", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "They have been stopped, your mom is safe! The tank and vehicles are now yours to take.";
};
