...
_setupObjects =
{
	...
	_missionHintText = format ["Some <t color='%2'>%1</t> have been spotted - painted black. <br/>Is this the first evidence for ISIS on Altis!?", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Jesus Christ! No ISIS - just black painted Offroaders! Save their cargo and pray to ...MONEY!";
};
