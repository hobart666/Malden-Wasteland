...
_setupObjects =
{
	...
	_heliChoices =
	[
	    ["O_T_VTOL_02_infantry_F", "O_T_VTOL_02_infantry_F"]
		//["B_Heli_Light_01_armed_F", "B_Heli_Light_01_armed_F"],
		//["B_Heli_Transport_01_camo_F", "B_Heli_Light_01_armed_F"],
		//["O_T_VTOL_02_infantry_F", "B_Heli_Light_01_armed_F"]
	];

	if (missionDifficultyHard) then
	{
		(_heliChoices select 0) set [0, "O_T_VTOL_02_infantry_F"];
		(_heliChoices select 1) set [0, "O_T_VTOL_02_infantry_F"];
		(_heliChoices select 2) set [0, "O_T_VTOL_02_infantry_F"];
	};
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "Heli_Transport_01_base_F" || _type isKindOf "B_T_VTOL_01_armed_F"):
			{
			...
			case (_type isKindOf "O_T_VTOL_02_infantry_F" || _type isKindOf "Heli_Attack_02_base_F"):
			{
