...
private ["_groupCount","_localGrpCount","_grp","_rdCount","_n","_r","_tempUnit","_tempVeh","_driverWeaponTypes"];
_mkr= (_this select 0);
...
if (!(server getvariable _trigID)) exitwith {_isActive=false;};
	...
	[_veh] call randomWeapons;
	_unit = [_grp, _tempPos] call createArmedCiv;  // I cant work out how to call createArmedCiv and pass it the vehicle details	
//	_unit = _grp createUnit [_tempUnit, getpos _veh, [], 0, "CAN_COLLIDE"];
		_veh setdir _direction;
// hacked in some modified code from creatArmedCiv cause I cant work out how to call it and pass it the vehicle details				
...
_unit addItemToVest "HandGrenade";
			...
			[_unit, _driverWeaponTypes call BIS_fnc_selectRandom, 3] call BIS_fnc_addWeapon;
