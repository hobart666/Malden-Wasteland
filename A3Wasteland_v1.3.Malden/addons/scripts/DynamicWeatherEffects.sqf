...
_minTimeBetweenWeatherChangesMin = 45;
...
_maxTimeBetweenWeatherChangesMin = 75;
...
_maxRainIntervalTimeMin = (_maxWeatherChangeTimeMin + _maxTimeBetweenWeatherChangesMin) / 30;
