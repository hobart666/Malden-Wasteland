...
if ((getPlayerUID player) in ["76561198049621925","76561198049329273","76561198021648470","76561198211887461"]) then { //all admins
	if ((getPlayerUID player) in ["76561198049621925","76561198049329273","76561198021648470","76561198211887461"]) then { //Admins Go Here aswell
		adminmenu =
		[
			["Fusions Menu",true],
...
[
	["Tools",true],
		...
		["Player Ammo", [10],  "", -5, [["expression", format[_EXECscript1,"otherammo.sqf"]]], "1", "1"],
		//["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
